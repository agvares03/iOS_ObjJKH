...
//        targetName = "УК Легкая жизнь"
        #elseif isMobileMIR
        debtArr.forEach{
            print($0["INN"] as! String, $0["Ident"] as! String)
            if debtArr.count > 1{
                if String($0["Ident"] as! String) == selectLS{
        ...
        #elseif isGrinvay
        shopCode = "341650"
        targetName = "Грин-Вэй Сочи"
        #elseif isGumse
        shopCode = "341640"
        targetName = "УК Гюмсе"
        #elseif isSV14
        shopCode = "341653"
        targetName = "ТСЖ Сивцев Вражек 14"
        #elseif isTSJ_Life
        shopCode = "345533"
        targetName = "ТСЖ Жизнь"
        #elseif isSouthValley
        shopCode = "345605"
        targetName = "Южная долина"
        #elseif isVestSnab
        shopCode = "355954"
        targetName = "УК Вест-Снаб"
        #elseif isSuhanovo
        shopCode = "356524"
        targetName = "УК Суханово Парк"
        #endif
