//
//  MobilePaysController.swift
//  ObjJKH
//
//  Created by Sergey Ivanov on 01/03/2019.
//  Copyright © 2019 The Best. All rights reserved.
//

import UIKit

class MobilePaysController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    private var values: [MobilePayCellData] = []
                                                        ...
                                                        if let json_bills = json["data"] {
                                                            ...
                                                            if (int_end < 0) {
                                                                ...
                                                                for index in 0...int_end {
                                                                    ...
                                                                    self.values.append(MobilePayCellData(date: bill_date, id: bill_id, ident: bill_ident, idPay: bill_idPay, sum: bill_sum, status: bill_status, desc: bill_desc, width: width))
                                                                }
                                                            }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "MobilePayCell", for: indexPath) as! MobilePayCell
...
class MobilePayCell: UITableViewCell {
    ...
    fileprivate func display(_ item: MobilePayCellData) {
...
private final class MobilePayCellData {
    ...
    init(date: String?, id: String?, ident: String?, idPay: String?, sum: String?, status: String?, desc: String?, width: CGFloat) {
