...
+ (NSArray *)testTerminals
{
    ...
    if ([savedValue  isEqual: @"MUP_IRKC"] || [savedValue  isEqual: @"Perspectiva"] || [savedValue  isEqual: @"MobileMIR"] || [savedValue  isEqual: @"Zarinsk"] || [savedValue  isEqual: @"Invest"] || [savedValue  isEqual: @"UniversSol"] || [savedValue  isEqual: @"ClearCity"]){
